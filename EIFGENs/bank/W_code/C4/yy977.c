...
extern EIF_TYPED_VALUE F977_8069(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F977_8069 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 976, Current, 4, 1, 13627);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
			...
			default:
				...
				if ((EIF_BOOLEAN)(arg1 == ((EIF_INTEGER_32) 0L))) {
					...
					for (;;) {
						...
						uc1 = tc1;
						ui4_1 = loc2;
						(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(1734, "put", Result))(Result, uc1x, ui4_1x);
						RTHOOK(41);
						uc1 = loc1;
						ui4_1 = loc3;
						(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(1734, "put", Result))(Result, uc1x, ui4_1x);
