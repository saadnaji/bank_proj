...
extern EIF_TYPED_VALUE F928_7345(EIF_REFERENCE);
...
RTOID (F928_7345)
EIF_TYPED_VALUE F928_7345 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 927, Current, 0, 0, 12958);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(927, Current, 12958);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
