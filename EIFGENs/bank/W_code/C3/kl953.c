...
extern EIF_TYPED_VALUE F953_7636(EIF_REFERENCE);
...
EIF_TYPED_VALUE F953_7636 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 952, Current, 0, 0, 13299);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(952, Current, 13299);
	RTIV(Current, RTAL);
	RTHOOK(1);
