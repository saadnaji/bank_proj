/*
 * Code for class TRANSFER_INTERFACE
 */
...
extern void F888_7165(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit888(void);
extern EIF_REFERENCE _A888_42_2_3_4();
...
/* {TRANSFER_INTERFACE}.make */
void F888_7165 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 887, Current, 3, 3, 12814);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(887, Current, 12814);
	RTCC(arg1, 887, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 887, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTCC(arg3, 887, l_feature_name, 3, eif_attached_type(893));
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+2) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF11,241,0xFF11,0,0xFF11,0xFFF9,3,173,0xFF11,219,0xFF11,219,178,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[3] = dftype;
		
		typres0 = eif_compound_id(dftype, typarr0);
		tr4 = RTLNRW(typres0, 0, (EIF_POINTER) _A888_42_2_3_4, (EIF_POINTER)(0),5087, tr2, 0, 1, -1, tr1, 3);
	}
	RTAR(Current, tr4);
	*(EIF_REFERENCE *)(Current + RTWA(5075, dtype)) = (EIF_REFERENCE) RTCCL(tr4);
	...
	if (tb2) {
		ui4_1 = ((EIF_INTEGER_32) 3L);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2382, "item", arg2))(arg2, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		tr1 = RTCCL(tr2);
		RTOB(*(EIF_REAL_32 *), 178, tr1, loc3, tb2);
		tb1 = tb2;
	}
	if (tb1) {
		RTHOOK(5);
