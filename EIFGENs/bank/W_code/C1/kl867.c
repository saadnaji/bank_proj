...
extern EIF_TYPED_VALUE F867_6989(EIF_REFERENCE);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 866, Current, 0, 0, 12664);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F867_6989)
EIF_TYPED_VALUE F867_6989 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 866, Current, 0, 0, 12665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTS (6988,F867_6988)
	RTOTS (6989,F867_6989)
}
