/*
 * Code for class WITHDRAW_INTERFACE
 */
...
extern void F882_7156(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit882(void);
extern EIF_REFERENCE _A882_42_2_3();
...
/* {WITHDRAW_INTERFACE}.make */
void F882_7156 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 881, Current, 2, 3, 12808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTCC(arg3, 881, l_feature_name, 3, eif_attached_type(893));
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+1) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr4 = RTLNRW(typres0, 0, (EIF_POINTER) _A882_42_2_3, (EIF_POINTER)(0),5084, tr2, 0, 1, -1, tr1, 2);
	}
	RTAR(Current, tr4);
