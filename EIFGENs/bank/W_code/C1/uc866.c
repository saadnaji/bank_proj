...
extern EIF_TYPED_VALUE F866_6987(EIF_REFERENCE);
...
RTOID (F866_6987)
EIF_TYPED_VALUE F866_6987 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 865, Current, 0, 0, 12663);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
