...
extern EIF_TYPED_VALUE F870_7011(EIF_REFERENCE);
...
RTOID (F870_7011)
EIF_TYPED_VALUE F870_7011 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 869, Current, 0, 0, 12671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
