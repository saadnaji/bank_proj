/*
 * Code for class DEPOSIT_INTERFACE
 */
...
extern void F884_7159(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit884(void);
extern EIF_REFERENCE _A884_42_2_3();
...
/* {DEPOSIT_INTERFACE}.make */
void F884_7159 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 883, Current, 2, 3, 12810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(883, Current, 12810);
	RTCC(arg1, 883, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 883, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTCC(arg3, 883, l_feature_name, 3, eif_attached_type(893));
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+1) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF11,241,0xFF11,0,0xFF11,0xFFF9,2,173,0xFF11,219,178,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[3] = dftype;
		
		typres0 = eif_compound_id(dftype, typarr0);
		tr4 = RTLNRW(typres0, 0, (EIF_POINTER) _A884_42_2_3, (EIF_POINTER)(0),5085, tr2, 0, 1, -1, tr1, 2);
	}
	RTAR(Current, tr4);
	*(EIF_REFERENCE *)(Current + RTWA(5075, dtype)) = (EIF_REFERENCE) RTCCL(tr4);
	...
	if (EIF_TEST(loc1)) {
		...
		tr1 = RTCCL(tr2);
		RTOB(*(EIF_REAL_32 *), 178, tr1, loc2, tb2);
		tb1 = tb2;
	}
	if (tb1) {
		RTHOOK(5);
