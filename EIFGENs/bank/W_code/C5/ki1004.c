...
extern EIF_TYPED_VALUE F1004_7227(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1004_7228(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_7230(EIF_REFERENCE);
extern void F1004_7235(EIF_REFERENCE);
extern void F1004_7236(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1004_7227 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1003, Current, 2, 3, 12856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 12856);
	{
		static EIF_TYPE_INDEX typarr0[] = {1002,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(5154, dtype, Dftype(Current));
		
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg1, 1003, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			...
			uc1 = tc1;
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5016, "put", arg1))(arg1, uc1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
...
EIF_TYPED_VALUE F1004_7228 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 12857);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 12857);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1004_7230 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 12858);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 12858);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F1004_7235 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 12859);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 12859);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1004_7236 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 12860);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 12860);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
