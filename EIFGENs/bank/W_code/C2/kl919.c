...
extern EIF_TYPED_VALUE F919_7319(EIF_REFERENCE);
...
RTOID (F919_7319)
EIF_TYPED_VALUE F919_7319 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 918, Current, 0, 0, 12938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(918, Current, 12938);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
