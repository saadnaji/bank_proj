...
extern EIF_TYPED_VALUE F899_7205(EIF_REFERENCE);
...
RTOID (F899_7205)
EIF_TYPED_VALUE F899_7205 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 898, Current, 0, 0, 12852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(898, Current, 12852);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
