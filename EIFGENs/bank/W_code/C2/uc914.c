...
extern EIF_TYPED_VALUE F914_7280(EIF_REFERENCE);
...
RTOID (F914_7280)
EIF_TYPED_VALUE F914_7280 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 913, Current, 0, 0, 12909);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(913, Current, 12909);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
