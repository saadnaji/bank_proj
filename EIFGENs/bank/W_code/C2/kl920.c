...
extern EIF_TYPED_VALUE F920_7320(EIF_REFERENCE);
...
RTOID (F920_7320)
EIF_TYPED_VALUE F920_7320 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 919, Current, 0, 0, 12939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(919, Current, 12939);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
