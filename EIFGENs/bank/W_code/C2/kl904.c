...
extern EIF_TYPED_VALUE F904_7242(EIF_REFERENCE);
...
RTOID (F904_7242)
EIF_TYPED_VALUE F904_7242 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 903, Current, 0, 0, 12871);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(903, Current, 12871);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
