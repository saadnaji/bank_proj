...
static EIF_TYPE_INDEX gen_type1_902 [] = {0xFF11,237,0xFF12,901,0xFFFF};
...
static struct desc_info desc_902[] = {
	...
	{1, (BODY_INDEX)-1, 237, gen_type1_902},
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 219, gen_type13_902},
...
void Init902(void)
{
	...
	IDSC(desc_902 + 32, 422, 901);
	IDSC(desc_902 + 43, 408, 901);
}
