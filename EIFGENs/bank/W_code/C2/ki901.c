...
extern void F901_7208(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F901_7214(EIF_REFERENCE);
...
void F901_7208 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 900, Current, 0, 1, 12854);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(900, Current, 12854);
	RTCC(arg1, 900, l_feature_name, 1, eif_attached_type(219));
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F901_7214 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 900, Current, 0, 0, 12855);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(900, Current, 12855);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5127, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
